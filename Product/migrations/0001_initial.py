# Generated by Django 5.2 on 2025-06-29 16:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(help_text='Основной товар', on_delete=django.db.models.deletion.CASCADE, to='Product.product', verbose_name='Товар')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Product.store', verbose_name='Магазин/Склад')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='store',
            field=models.ForeignKey(help_text='К какому складу/магазину относится товар', on_delete=django.db.models.deletion.CASCADE, to='Product.store', verbose_name='Склад/Магазин'),
        ),
        migrations.CreateModel(
            name='PriceHistory',
            fields=[
                ...
                ('product', models.ForeignKey(help_text='Товар, для которого изменялась цена', on_delete=django.db.models.deletion.CASCADE, to='Product.product', verbose_name='Товар')),
                ('store', models.ForeignKey(help_text='Склад, на котором изменялась цена', on_delete=django.db.models.deletion.CASCADE, to='Product.store', verbose_name='Склад')),
            ],
        ),
        migrations.CreateModel(
            name='Inventory',
            fields=[
                ...
                ('variant', models.ForeignKey(help_text='Какой вариант товара', on_delete=django.db.models.deletion.CASCADE, to='Product.productvariant', verbose_name='Вариант товара')),
                ('store', models.ForeignKey(help_text='На каком складе находится товар', on_delete=django.db.models.deletion.CASCADE, to='Product.store', verbose_name='Склад')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(help_text='Для какого магазина эта категория', on_delete=django.db.models.deletion.CASCADE, to='Product.store', verbose_name='Магазин')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(help_text='К какой категории относится', on_delete=django.db.models.deletion.CASCADE, to='Product.category', verbose_name='Категория')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='sub_category',
            field=models.ForeignKey(help_text='К какой подкатегории относится', on_delete=django.db.models.deletion.PROTECT, to='Product.subcategory', verbose_name='Подкатегория'),
        ),
        migrations.AddField(
            model_name='product',
            name='unit',
            field=models.ForeignKey(blank=True, help_text='В каких единицах измеряется товар', null=True, on_delete=django.db.models.deletion.CASCADE, to='Product.unit', verbose_name='Единица измерения'),
        ),
        migrations.CreateModel(
            name='ProductImage',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('product', models.ForeignKey(help_text='Товар, к которому относится изображение', on_delete=django.db.models.deletion.CASCADE, related_name='product_images', to='Product.product', verbose_name='Товар')),
            ],
            options={
