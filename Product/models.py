...
class Store(models.Model):
    ...
    brand = models.ForeignKey(Brand, on_delete=models.CASCADE, verbose_name="Бренд", related_name='stores')
...
class Schedule(models.Model):
    ...
    store = models.ForeignKey(Store, on_delete=models.CASCADE, verbose_name="Магазин/Склад", related_name='schedules')
...
class Category(models.Model):
    ...
    store = models.ForeignKey(Store, on_delete=models.CASCADE, verbose_name="Магазин",
                            help_text="Для какого магазина эта категория", related_name='categories')
...
class SubCategory(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.CASCADE, verbose_name="Категория",
                              help_text="К какой категории относится", related_name='subcategories')
...
class Product(models.Model):
    ...
    sub_category = models.ForeignKey(SubCategory, on_delete=models.PROTECT, verbose_name="Подкатегория",
                                   help_text="К какой подкатегории относится", related_name='products')
    store = models.ForeignKey(Store, on_delete=models.CASCADE, verbose_name="Склад/Магазин",
                            help_text="К какому складу/магазину относится товар", related_name='products')

    unit = models.ForeignKey(Unit, on_delete=models.CASCADE, verbose_name="Единица измерения",
                           help_text="В каких единицах измеряется товар", null=True, blank=True, related_name='products')
...
class ProductVariant(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE, verbose_name="Товар",
                              help_text="Основной товар", related_name='variants')
...
class Inventory(models.Model):
    ...
    variant = models.ForeignKey(ProductVariant, on_delete=models.CASCADE, verbose_name="Вариант товара",
                              help_text="Какой вариант товара", related_name='inventories')
    store = models.ForeignKey(Store, on_delete=models.CASCADE, verbose_name="Склад",
                            help_text="На каком складе находится товар", related_name='inventories')
...
class PriceHistory(models.Model):
    ...
    id = models.BigAutoField(primary_key=True, verbose_name="ID")
    product = models.ForeignKey(Product, on_delete=models.CASCADE, verbose_name="Товар",
                              help_text="Товар, для которого изменялась цена", related_name='price_histories')
    store = models.ForeignKey(Store, on_delete=models.CASCADE, verbose_name="Склад",
                            help_text="Склад, на котором изменялась цена", related_name='price_histories')
